...
1. Read docs/gates.md. All tasks must be done with tests/commits recorded. Use agent-skills code-reviewer for the five-axis staff review. Record code_review for the exact review_commit; move in-review → in-appsec-review with the validator.
2. Run appsec-gate for mandatory final review. Record appsec_review for that same commit, then transition to ready-for-pr.
